    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            ...
            <form name="login" action="/user/loginPost" method="post">
                ...
                <input type="text" class="form-control" id="userEmail" name="userEmail" placeholder="가입한 Email을 입력해주세요" required autofocus>
                <input type="password" class="form-control" id="userPassword" name="userPassword" placeholder="Password를 입력해주세요" required >
                    ...
                    <%--<a href="/user/githubLogin">--%>
                     <%--<img width="100%" height="50" src="/resources/images/github.png"/>--%>
                        ...
                        <a class="btn btn-block btn-social naver"  href="/user/naverLogin" onclick="_gaq.push(['_trackEvent', 'btn-social', 'click', 'btn-google']);">
                            <img class="naverImg naver" src="/resources/images/Log in with NAVER_Icon_Green.PNG"/> Sign in with Naver
                        </a>
                        <a class="btn btn-block btn-social btn-google" href="/user/googleLogin" onclick="_gaq.push(['_trackEvent', 'btn-social', 'click', 'btn-google']);">
                            <span class="fa fa-google" style="line-height: 26px;"></span> Sign in with Google
                        </a>
                        <a class="btn btn-block btn-social btn-github" href="/user/githubLogin" onclick="_gaq.push(['_trackEvent', 'btn-social', 'click', 'btn-github']);">
                            <span class="fa fa-github" style="line-height: 26px;"></span> Sign in with GitHub
                        </a>
                </div>
