        ...
        <div class="col-sm-8 removePadding" >
            <div class="row removePadding">
                ...
                <div class="col-sm-4 removePadding borderRB " style="height:29%;margin-top:76.781px;">
                    ...
                    <li class="tip">  <button class="btn btn-primary btn-lg btn-block bd" style="width:102.5%;border:8pt solid #fff;height:40%;margin-bottom: 10px;position:relative;top:-45%;font-size: 28px;" href ="/edit/editPage">Edit</button>
